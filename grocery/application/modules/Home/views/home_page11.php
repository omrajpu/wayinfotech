...
?>
        ...
        <?php }?>
            ...
            <section class='kurta-banner-section'>
                <a href='#'>
                    <img alt='' class='mob-hide' src='<?php echo base_url(); ?>images/Manyavar_Web_Men_Wedding_Category01c6.jpg'>
                    <img alt='' class='desk-hide' src='<?php echo base_url(); ?>images/Manyavar_mWeb_Men_Wedding3fcc.jpg'>
                </a>
            </section>
