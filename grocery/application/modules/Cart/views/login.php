...
<div class="inner-bg">
	<div class="container">
		...
		<div class="row">
			<div class="col-sm-12  text text-center"><br>
				<h3>Login &amp; Register Forms</h3>
		...
		<div class="row">
			<div class="col-sm-5">
				...
				<div class="form-box">
					...
					<div class="form-bottom">
						...
						<form role="form" action="<?=base_url();?>/Cart/login_check" method="post" class="login-form">
			...
			<div class="col-sm-5">
				...
				<div class="form-box">
					...
					<div class="form-bottom">
						<form role="form" action="<?php echo base_url();?>/login/sumbit_check" method="post" class="registration-form">
							<div class="form-group">
