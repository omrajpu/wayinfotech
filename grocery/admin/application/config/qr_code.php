...
$config['cachedir'] 	= 'application/tmp/cache/'; //string, the default is tmp/cache/
$config['imagedir'] 	= 'qr_codes/'; //string, the default is tmp/qr_codes/
$config['errorlog'] 	= 'application/tmp/logs/'; //string, the default is tmp/logs/
