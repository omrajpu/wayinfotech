...
public function add_staff()
    {
        ...
        if ($this->input->server('REQUEST_METHOD') === 'POST') {
         ...
         //   $user_roll_id = $this->input->post('id');
          ...
          if($user_roll_id == '') {
           ...
           $save_data_id=$this->CrudModel->common_save_data($data, $validation_array, $table_name, $where_column, $file_upload,$folder_path='/upload/profile',$file_preffix='profile_','yes');
        ...
        if($user_id){
       $pageData['list_data'] = $this->CrudModel->getCommonData('system_admin', 'id', $user_id);
        }else
        {
