                                          ...
                                          <tr>
                                           <!--  <td><?php echo $i;?></td> -->
                                            ...
                                            <td>
                                                            ...
                                                            <a  style="padding-left: 2em;" onclick="deletes('system_admin','id','<?php echo $row->id; ?>','Blog_Category')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
