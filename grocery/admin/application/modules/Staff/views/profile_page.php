            <div class="content-wrapper">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="col-sm-10">
                <input type="text" id="mobile" name="mobile" value="" placeholder="Mobile" id="input-meta-title1" class="form-control">
                </div>
                </div>
                ...
                <div class="col-sm-10">
                <input type="text" name="email" placeholder="Email" id="input-meta-keyword1" class="form-control"></textarea>
                </div>
                </div>
                </div>
                </div>
