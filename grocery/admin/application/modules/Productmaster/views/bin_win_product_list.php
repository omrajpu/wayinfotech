<div class="content-wrapper">
               ...
               <div class="content-header">
                ...
                <h2>Manage Bin/win Product</h2>
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/bin_win_product_list">Manage Bin - Win</a></li>
                        
                       <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_bin_win" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                ...
                                <div class="box-body">
                                    ...
                                    <table id="category_view" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                         ...
                                         //print_r($cat_data);
                                        $i=1;
                                        foreach ($bin_win_product_list as $row) {
       ...
       # code...
                                        ...
                                        ?>
                                          <tr>
                                            ...
                                            <td><?php echo getname($row->cat_id,'category_details','category_name');?></td>

                                            <td><?php echo getname($row->sub_cat_id,'sub_category_details','sub_category_name');?></td>
                                           
                                            <td><?php echo getname($row->product_id,'tbl_products','product_name');?></td>

                                           

                                            <td><?php echo getname($row->bin_id,'tbl_products','product_name');?></td>

                                            <td><?php echo getname($row->win_id,'tbl_products','product_name');?></td>
                                         ...
                                         <td>InActive</td>
                                           ...
                                           ?>
                                            <td>
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_bin_win/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/delete_bin_win/<?php echo @$row->id;?>" onclick="confirm('Are you sure you want to delete?')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
    ...
    <div class="modal fade" id="show_view_page"  tabindex="-1" role="dialog" aria-labelledby="myModalLarge">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <center><h4  style="color:green"class="modal-title" id="myModalLarge">Bin - win Product details</h4></center>
                </div>
