               ...
               <div class="content-wrapper">
                ...
                <ol class="breadcrumb">
                    <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a class="active" href="<?php echo base_url()?>Productmaster/brand_list">Blog</a></li>
        ...
        <div style="display: none" id="glob_msg" class="alert alert-block alert-error">
             ...
             <div class="text-center"> 
              ...
              <div class="nav-tabs-custom">
                ...
                <form action="<?php echo base_url();?>/Productmaster/save_blog_data" method="post" enctype="multipart/form-data" id="form-category" class="form-horizontal">
                
                <input type="hidden" name="parent_id" value="<?php echo $parent_id;?>">
                <input type="hidden" name="data_id" value="<?php echo $single_cat_data->id;?>">
                ...
                <div class="col-sm-10">
                <input type="text" name="name" id="name" value="<?php echo set_value('name'); ?><?php echo @$single_cat_data->title;?>" placeholder="Name" class="form-control">
                <?php echo form_error('brand_name', '<div class="error"><p style="color:red">', '</p></div>'); ?>
                </div>
                </div>

                <div class="form-group">
                <label class="col-sm-2 control-label" for="input-name1">Upload Image <span style="color:red">*</span></label>
                <div class="col-sm-10">
                <input type="file" name="image" id="image" class="form-control">
                <input type="hidden" name="old_image" value="<?php echo @$single_cat_data->image;?>">
               <?php
  if(!empty($single_cat_data->image)){
      ?>
<img src="<?php echo base_url().'upload/blog/'.$single_cat_data->image?> " width="50">
      <?php
  }
               ?>
                </div>
