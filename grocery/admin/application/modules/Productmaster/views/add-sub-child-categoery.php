 ...
 function get_id(id){
   $("#photo_"+id).val(id);
                ...
                <div class="col-sm-10">
                <select required=""  onchange="get_cat_id(this.value)" name="cat_id" id="input-store" class="form-control">
              ...
              <!--   <div class="form-group">
                <label class="col-sm-2 control-label">Feature Sub Child Category</label>
                <div class="col-sm-10">
