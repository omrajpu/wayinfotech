 <div class="content-wrapper">
               <div class="content-header">
                ...
                <ol class="breadcrumb">
                    ...
                    <li><a class="active" href="<?php echo base_url()?>Productmaster/brand_list">Slider</a></li>
                        
                       <div class="pull-right"><a href="<?php echo base_url()?>Productmaster/add_home_slider" data-toggle="tooltip" title="" class="btn btn-primary" data-original-title="Add New"><i class="fa fa-plus"></i></a> <a href="#" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Rebuild"><i class="fa fa-refresh"></i></a>
                                        ...
                                        ?>
                                          <tr>
                                           <!--  <td><?php echo $i;?></td> -->
                                            ...
                                            <td>
                                                            <a  style="padding-left: 2em;" href="<?php echo site_url();?>Productmaster/add_home_slider/<?php echo @$row->id;?>"><span class="glyphicon glyphicon-edit" aria-hidden="true"></span></a> 
                                                            <a  style="padding-left: 2em;" onclick="deletes('top_home_silider','id','<?php echo $row->id; ?>','Blog_Category')"><span class="glyphicon glyphicon glyphicon-trash" aria-hidden="true"></span></a> 
         ...
         function view(id)
            {
                ...
                {
                    //alert("dfggf");
                    var url = "<?php echo base_url('Productmaster/view_slider'); ?>";
                    $.ajax({
                        url: url,
                        data: {'id': id},
                        type: "POST",
    ...
    <div class="modal fade" id="show_view_page"  tabindex="-1" role="dialog" aria-labelledby="myModalLarge">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    <center><h4  style="color:green"class="modal-title" id="myModalLarge">Slider Details</h4></center>
                </div>
