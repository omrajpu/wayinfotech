        ...
        <div style="display: none" id="glob_msg" class="alert alert-block alert-error">
             ...
             <div class="text-center"> 
              ...
              <div class="nav-tabs-custom">
                ...
                <h3 class="panel-title"><i class="fa fa-pencil"></i> Add Chatity</h3>
                 </div>
                ...
                <div class="form-group required">
                <label class="col-sm-2 control-label" for="input-name1">Upload Logo <span style="color:red">*</span></label>
                <div class="col-sm-10">
