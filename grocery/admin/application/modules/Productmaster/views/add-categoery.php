             ...
             <div class="col-md-12">
              ...
              <div class="nav-tabs-custom">
                ...
                <div class="tab-pane" id="tab-data">
                  <br>
                <!-- <div class="form-group">
                <label class="col-sm-2 control-label" for="input-parent">Under Parent</label>
                <div class="col-sm-10">
                <input type="text" name="path" value="" placeholder="Parent" id="input-parent" class="form-control" autocomplete="off"><ul class="dropdown-menu"></ul>
                <input type="hidden" name="parent_id" value="0">
                </div>
                </div> -->

               <!--  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-subtract">Under Parent</label>
                <div class="col-sm-10">
               ...
               <!--  <div class="form-group">
                <label class="col-sm-2 control-label" for="input-subtract">Variant</label>
                <div class="col-sm-10">
                <select multiple="multiple" name="variant[]" id="input-store" class="form-control">
               ...
               <!--  <div class="form-group">
                <label class="col-sm-2 control-label">Feature Category</label>
                <div class="col-sm-10">
