 <div class="content-wrapper">
               <div class="content-header">
                ...
                <div class="pull-right">
                  <a href="<?php echo base_url()?>Productmaster/cod_orders" data-toggle="tooltip" title="" class="btn btn-default" data-original-title="Cancel"><i class="fa fa-reply"></i></a>
                </div>
                </ol>
                </div>
                </div>
    ...
    foreach ($product_details as $val) {
     ...
     ?>
      <tr>
        ...
        <td>
        <img class="quicklook" id="" style="width: 100px;" src="<?=base_url();?>upload/product_images/<?php echo @$val->p_image;?>" alt="">
       
     </td>

       <!--   <td>INR <?php echo number_format($val->winprice,2);?></td> -->
       
        
     <!-- <td>
        <img class="quicklook" id="" style="width: 100px;" src="<?=base_url();?>upload/product_images/<?php echo @$val->win_image;?>" alt="">
